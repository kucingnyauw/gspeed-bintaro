...
/**
 * Nilai default untuk filter shift.
 * @constant
 */
...
/**
 * Custom hook untuk mengelola state filter shift dengan mekanisme apply/temporary.
 *
 ...
 * - `status`: Filter berdasarkan status shift (ACTIVE/CLOSED).
 ...
 * } = useShiftFilters();
 *
 * const { data } = useShiftsQuery(activeFilters);
 *
 * return (
 *   <>
