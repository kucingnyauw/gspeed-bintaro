    ...
    <Dialog fullWidth maxWidth="xs" onClose={mutation.isPending ? undefined : onClose} open={open}>
      ...
      <DialogContent sx={{ pt: 2.5, pb: 3 }}>
        <Typography variant="body1" color="text.secondary">
          Anda akan menghapus{" "}
          <strong>{selectedCount} mutasi stok</strong> yang dipilih.
        </Typography>
        <Typography variant="body2" color="error.main" sx={{ mt: 2 }}>
          Tindakan ini tidak dapat dibatalkan. Data mutasi stok akan dihapus permanen.
        </Typography>
      </DialogContent>
      ...
      <DialogActions sx={{ px: 3, py: 2.5 }}>
        ...
        >
          {mutation.isPending ? "Menghapus..." : `Hapus ${selectedCount} Mutasi Stok`}
        </Button>
      </DialogActions>
    </Dialog>
  );
