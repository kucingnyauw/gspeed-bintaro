...
BEGIN
  ...
  IF UPPER(user_role) NOT IN ('ADMIN', 'CASHIER', 'MECHANIC') THEN
    user_role := 'CASHIER';
  ELSE
...
-- ============================================================
-- 2. Trigger: Cegah hapus user dengan relasi aktif
-- ============================================================
...
-- ============================================================
-- 3. Trigger: Hapus user di auth.users saat public."User" dihapus
-- ============================================================
...
-- ============================================================
-- 4. Trigger: Cascade Soft Delete Order
-- ============================================================
...
-- ============================================================
-- 5. Trigger: Audit Product Changes
-- ============================================================
...
-- ============================================================
-- 6. Trigger: Audit User Status & Role Changes
-- ============================================================
...
-- ============================================================
-- 7. Trigger: Audit Order Status Changes
-- ============================================================
...
-- ============================================================
-- 8. Trigger: Audit Payment Changes
-- ============================================================
...
-- ============================================================
-- 9. Trigger: Audit Expense Changes
-- ============================================================
...
-- ============================================================
-- 10. Trigger: Audit Stock Movement
-- ============================================================
...
-- ============================================================
-- 11. Trigger: Audit Shift Changes
-- ============================================================
...
-- ============================================================
-- 12. Trigger: Auto Delete Notifications
-- ============================================================
...
-- ============================================================
-- 13. Function: Manual Cleanup (Cron Job)
-- ============================================================
